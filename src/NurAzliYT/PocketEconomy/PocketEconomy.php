 ...
 * Copyright (C) 2013-2017  NurAzliYT <jyc00410@gmail.com>
 *
...
namespace NurAzliYT\PocketEconomy;
...
use NurAzliYT\PocketEconomy\provider\Provider;
use NurAzliYT\PocketEconomy\provider\YamlProvider;
use NurAzliYT\PocketEconomy\provider\MySQLProvider;
use NurAzliYT\PocketEconomy\event\money\SetMoneyEvent;
use NurAzliYT\PocketEconomy\event\money\ReduceMoneyEvent;
use NurAzliYT\PocketEconomy\event\money\AddMoneyEvent;
use NurAzliYT\PocketEconomy\event\money\MoneyChangedEvent;
use NurAzliYT\PocketEconomy\event\account\CreateAccountEvent;
use NurAzliYT\PocketEconomy\task\SaveTask;
...
class PocketEconomy extends PluginBase implements Listener
{
    ...
    {
        DefaultPermissions::registerPermission(new Permission("pocketeconomy.*", "Allows to control all of functions in PocketEconomy", [
        ...
        DefaultPermissions::registerPermission(new Permission("pocketeconomy.*", "Allows to control all of functions in PocketEconomy", ["pocketeconomy.command.*"]));
    }
